...
This guide provides comprehensive documentation for the **community** skill in the custom-plugin-devrel-engineer plugin.
...
```bash
# Invoke the skill
claude "community - [your task description]"

# Example
claude "community - analyze the current implementation"
```
...
def implement_community(input_data):
    """
