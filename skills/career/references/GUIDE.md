...
This guide provides comprehensive documentation for the **career** skill in the custom-plugin-devrel-engineer plugin.
...
```bash
# Invoke the skill
claude "career - [your task description]"

# Example
claude "career - analyze the current implementation"
```
...
def implement_career(input_data):
    """
    Implement career functionality.
