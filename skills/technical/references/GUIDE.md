...
This guide provides comprehensive documentation for the **technical** skill in the custom-plugin-devrel-engineer plugin.
...
```bash
# Invoke the skill
claude "technical - [your task description]"

# Example
claude "technical - analyze the current implementation"
```
...
def implement_technical(input_data):
    """
