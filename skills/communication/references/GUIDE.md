...
This guide provides comprehensive documentation for the **communication** skill in the custom-plugin-devrel-engineer plugin.
...
```bash
# Invoke the skill
claude "communication - [your task description]"

# Example
claude "communication - analyze the current implementation"
```
...
def implement_communication(input_data):
    """
