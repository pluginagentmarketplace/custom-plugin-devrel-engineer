...
This guide provides comprehensive documentation for the **onboarding** skill in the custom-plugin-devrel-engineer plugin.
...
```bash
# Invoke the skill
claude "onboarding - [your task description]"

# Example
claude "onboarding - analyze the current implementation"
```
...
def implement_onboarding(input_data):
    """
