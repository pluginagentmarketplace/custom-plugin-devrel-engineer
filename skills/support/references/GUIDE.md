...
This guide provides comprehensive documentation for the **support** skill in the custom-plugin-devrel-engineer plugin.
...
```bash
# Invoke the skill
claude "support - [your task description]"

# Example
claude "support - analyze the current implementation"
```
...
def implement_support(input_data):
    """
