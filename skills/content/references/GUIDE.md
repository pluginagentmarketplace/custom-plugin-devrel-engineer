...
This guide provides comprehensive documentation for the **content** skill in the custom-plugin-devrel-engineer plugin.
...
```bash
# Invoke the skill
claude "content - [your task description]"

# Example
claude "content - analyze the current implementation"
```
...
def implement_content(input_data):
    """
    Implement content functionality.
